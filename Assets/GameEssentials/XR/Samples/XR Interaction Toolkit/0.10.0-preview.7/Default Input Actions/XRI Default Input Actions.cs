// GENERATED AUTOMATICALLY FROM 'Assets/GameEssentials/XR/Samples/XR Interaction Toolkit/0.10.0-preview.7/Default Input Actions/XRI Default Input Actions.inputactions'
...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""OpenQuickInventory"",
                    ""type"": ""Value"",
                    ""id"": ""567e3c83-9da6-4509-b91e-d1c0da0888d6"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""772910e9-1acd-4c68-9f09-e9f12abc517b"",
                    ""path"": ""<XRController>{LeftHand}/primary2DAxisClick"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""OpenQuickInventory"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_OpenQuickInventory = m_XRILeftHand.FindAction("OpenQuickInventory", throwIfNotFound: true);
        // XRI RightHand
    ...
    private readonly InputAction m_XRILeftHand_OpenQuickInventory;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @OpenQuickInventory => m_Wrapper.m_XRILeftHand_OpenQuickInventory;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @OpenQuickInventory.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnOpenQuickInventory;
                @OpenQuickInventory.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnOpenQuickInventory;
                @OpenQuickInventory.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnOpenQuickInventory;
            }
            ...
            if (instance != null)
            {
                ...
                @OpenQuickInventory.started += instance.OnOpenQuickInventory;
                @OpenQuickInventory.performed += instance.OnOpenQuickInventory;
                @OpenQuickInventory.canceled += instance.OnOpenQuickInventory;
            }
        }
    }
    ...
    public interface IXRILeftHandActions
    {
        ...
        void OnOpenQuickInventory(InputAction.CallbackContext context);
    }
